...
void DrawUI()
{
    ...
    if (ui_create.changedParams1)
    { // if user changed one of important parameters
        mainCam.pos = ui_create.previewPlanet->position +
                      glm::vec3(ui_create.previewPlanet->scale.x * 2, 0,
                                ui_create.previewPlanet->scale.x * 2);
        mainCam.front =
            glm::normalize(ui_create.previewPlanet->position - mainCam.pos);
...
void CreatePlanet()
{
    ...
    ImGui::SetNextWindowPos(ImVec2(5, mainManipulationWindowSize.y + 20),
                            ImGuiCond_Once);
    ImGui::SetWindowSize(
        ImVec2(300, scr_height - mainManipulationWindowSize.y - 100),
        ImGuiCond_Once);
    ImGui::Begin("Create planet");
    ImGui::Text("Planets name");
    ImGui::SameLine();
    ImGui::InputText("##text", ui_create.buf, sizeof(ui_create.buf));
    ImGui::Text("Planets mass");
    ImGui::SameLine();
    ImGui::InputFloat("##mass", &ui_create.mass, 100, 1000);
    ImGui::Text("Planets radius");
    ImGui::SameLine();
    ImGui::InputFloat("##radius", &ui_create.radius, 0.1f, 1.0f);
    ImGui::Text("Planets position");
    ImGui::SameLine();
    ImGui::InputFloat3("##pos", ui_create.pos);
    ImGui::Text("Planets velocity");
    ImGui::SameLine();
    ImGui::InputFloat3("##vel", ui_create.vel);
    ImGui::Text("Level of detail");
    ImGui::SameLine();
    ImGui::InputScalar("##lod", ImGuiDataType_U32, &ui_create.LOD);
    ...
    if (ImGui::CollapsingHeader("Noises"))
    {
        for (int i = 0; i < ui_create.noises.size(); i++)
        {
            ...
            if (ImGui::CollapsingHeader(
                    (std::string("Noise ") + std::to_string(i)).c_str()))
            {
                ImGui::Text("Seed");
                ImGui::SameLine();
                ImGui::DragScalar(
                    (hashtags + "seed" + std::to_string(i)).c_str(),
                    ImGuiDataType_U32, &ui_create.noises[i].seed);
                ImGui::Text("Strength");
                ImGui::SameLine();
                ImGui::InputFloat(
                    (hashtags + "strength" + std::to_string(i)).c_str(),
                    &ui_create.noises[i].strength, 0.1f);
                ImGui::Text("Octaves");
                ImGui::SameLine();
                ImGui::InputScalar(
                    (hashtags + "octaves" + std::to_string(i)).c_str(),
                    ImGuiDataType_U32, &ui_create.noises[i].octaves);
                ImGui::Text("Persistance");
                ImGui::SameLine();
                ImGui::InputScalar(
                    (hashtags + "persistance" + std::to_string(i)).c_str(),
                    ImGuiDataType_U32, &ui_create.noises[i].persistance);

                if (ImGui::Button(
                        ("Delete this noise ##" + std::to_string(i)).c_str()))
                {
                    ui_create.previewPlanet->noises.erase(
                        ui_create.previewPlanet->noises.begin() + i);
                ...
                bool hasInputted =
                    ui_create.noises[i].octaves !=
                        ui_create_o.noises[i].octaves ||
                    ui_create.noises[i].persistance !=
                        ui_create_o.noises[i].persistance ||
                    ui_create.noises[i].seed != ui_create_o.noises[i].seed ||
                    ui_create.noises[i].strength !=
                        ui_create_o.noises[i].strength;
                if (hasInputted)
                {
                    ui_create.regeneratePlanet = true;
                }

                ui_create.noises[i].octaves = std::clamp(
                    static_cast<int>(ui_create.noises[i].octaves), 0, 100);
                ui_create.previewPlanet->noises[i].seed =
                    ui_create.noises[i].seed;
                ui_create.previewPlanet->noises[i].octaves =
                    ui_create.noises[i].octaves;
                ui_create.previewPlanet->noises[i].persistance =
                    ui_create.noises[i].persistance;
                ui_create.previewPlanet->noises[i].strength =
                    ui_create.noises[i].strength;
            }
        }
    }
    ...
    if (ImGui::CollapsingHeader("Colors"))
    {
        for (int i = 0; i < ui_create.heights.size(); i++)
        {
                    ...
                    (std::string("Color ") + std::to_string(i)).c_str()))
            {
                ...
                ImGui::SameLine();
                ImGui::InputFloat(
                    (hashtags + "height" + std::to_string(i)).c_str(),
                    &ui_create.heights[i].height);
                ImGui::Text("Color");
                ImGui::SameLine();
                ImGui::ColorPicker3(
                    (hashtags + "col" + std::to_string(i)).c_str(),
                    ui_create.heights[i].col);

                bool hasInputted = ui_create.heights[i].height !=
                                       ui_create_o.heights[i].height ||
                                   (ui_create.heights[i].col[0] !=
                                        ui_create_o.heights[i].col[0] &&
                                    ui_create.heights[i].col[1] !=
                                        ui_create_o.heights[i].col[1] &&
                                    ui_create.heights[i].col[2] !=
                                        ui_create_o.heights[i].col[2]);
                if (hasInputted)
                {
                    ui_create.regeneratePlanet = true;
                }

                ui_create.previewPlanet->heights[i].height =
                    ui_create.heights[i].height;
                std::copy(std::begin(ui_create.heights[i].col),
                          std::end(ui_create.heights[i].col),
                          std::begin(ui_create.previewPlanet->heights[i].col));
            }
        }
    }

    if (ui_create.pos[0] != ui_create_o.pos[0] ||
        ui_create.pos[1] != ui_create_o.pos[1] ||
        ui_create.pos[2] != ui_create_o.pos[2])
    {
    ...
    if (ImGui::Button("Create planet"))
    {
        for (auto &p : planets)
        {
            ...
            {
                errorText = "Planet with this name has already been created, "
        ...
        if (std::string(ui_create.buf).length() <= 0 || ui_create.mass <= 0 ||
            ui_create.radius <= 0)
        {
            errorText = "One of the parameters is wrong, check if the radius "
                        "or mass is not set to zero, or if a planet has a name";
            errorCode = 2;
            ui_create.canCreatePlanet = false;
        }
        ...
        if (ui_create.canCreatePlanet)
        {
            ...
            tempData.pos =
                glm::vec3(ui_create.pos[0], ui_create.pos[1], ui_create.pos[2]);
            tempData.vel =
                glm::vec3(ui_create.vel[0], ui_create.vel[1], ui_create.vel[2]);
            ...
            for (int i = 0; i < planets.back().mesh.vertices.size(); i++)
            {
                if (i > planets.back().appliedNoise.size())
                    break;
                planets.back().mesh.vertices[i].position +=
                    planets.back().appliedNoise[i];
            }
    ...
    if (ui_create.regeneratePlanet)
    {
        ...
        ui_create.previewPlanet->appliedNoise.resize(
            ui_create.previewPlanet->mesh.vertices.size(), glm::vec3(0));
        ...
        {
            ApplyNoise(*ui_create.previewPlanet,
                       ui_create.previewPlanet->noises[i]);
        }
        ...
        for (int i = 0; i < ui_create.previewPlanet->mesh.vertices.size(); i++)
        {
            if (i > ui_create.previewPlanet->appliedNoise.size())
                break;
            ui_create.previewPlanet->mesh.vertices[i].position +=
                ui_create.previewPlanet->appliedNoise[i];
        }
...
void ManipulationWindow()
{
    ...
    ImGui::Text("PreviewTimescale");
    ImGui::SameLine();
    ImGui::InputFloat("##previewTimescale", &previewTimeStep);
    if (ImGui::IsItemHovered())
        ImGui::SetTooltip("Speed at which planet prediction is running");

    ImGui::Text("Prediciton depth");
    ImGui::SameLine();
    ImGui::InputScalar("##predictionDepth", ImGuiDataType_U32,
                       &predictionDepth);
    if (ImGui::IsItemHovered())
...
void UpdatePlanet()
{
    ...
    ImGui::Text("Mass");
    ImGui::SameLine();
    ImGui::InputFloat("##mass", &ui_update.mass);
    ImGui::Text("Velocity");
    ImGui::SameLine();
    ImGui::InputFloat3("##velocity", ui_update.vel);
    ImGui::Text("Emission Strength");
    ImGui::SameLine();
    ImGui::InputFloat("##emissionstrength", &ui_update.emissionStrength);
    ImGui::Text("Radius");
    ImGui::SameLine();
    ImGui::InputFloat("##radius", &ui_update.radius);
    ImGui::Text("Level of detail");
    ImGui::SameLine();
    ImGui::InputScalar("##lod", ImGuiDataType_U32, &ui_update.LOD);
    if (ImGui::IsItemHovered())
        ImGui::SetTooltip("How detailed planet is");
    ...
    {
        ImGui::Text("EmissionColor");
        ImGui::ColorPicker4("##emissioncolor", ui_update.emissionCol);
    }

    if (ImGui::Button("Update"))
    {
        currentPlanet->vel =
            glm::vec3(ui_update.vel[0], ui_update.vel[1], ui_update.vel[2]);
        currentPlanet->mass = ui_update.mass;
        currentPlanet->emissionStrength = ui_update.emissionStrength;
        currentPlanet->emissionCol =
            glm::vec4(ui_update.emissionCol[0], ui_update.emissionCol[1],
                      ui_update.emissionCol[2], ui_update.emissionCol[3]);
    ...
    if (ImGui::CollapsingHeader("Create noise"))
    {
        ImGui::Text("Seed");
        ImGui::SameLine();
        ImGui::DragScalar("##seedA", ImGuiDataType_U32,
                          &ui_update.tempNoise.seed, 1);
        ImGui::Text("Octaves");
        ImGui::SameLine();
        ImGui::InputScalar("##octavesA", ImGuiDataType_U32,
                           &ui_update.tempNoise.octaves);
        ImGui::Text("Persistance");
        ImGui::SameLine();
        ImGui::InputScalar("##persistanceA", ImGuiDataType_U32,
                           &ui_update.tempNoise.persistance);
        ImGui::Text("Strength");
        ImGui::SameLine();
        ImGui::InputFloat("##strengthA", &ui_update.tempNoise.strength);
        ui_update.tempNoise.octaves =
            std::min(static_cast<int>(ui_update.tempNoise.octaves), 100);
        if (ImGui::Button("Add noise"))
        {
    ...
    if (ImGui::CollapsingHeader("Add new color"))
    {
        ImGui::Text("Height");
        ImGui::SameLine();
        ImGui::InputFloat("##heightA", &ui_update.tempHeightCol.height);
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("The threshold after the color is applied");

        ImGui::Text("Color");
        ImGui::SameLine();
        ImGui::ColorPicker3("##colorA", ui_update.tempHeightCol.col);
        if (ImGui::Button("Add color"))
        {
    ...
    if (ImGui::CollapsingHeader("Noises"))
    {
        for (int i = 0; i < ui_update.noises.size(); i++)
        {
                    ...
                    (std::string("Noise ") + std::to_string(i)).c_str()))
            {
                ...
                ImGui::DragScalar(
                    (hashtags + "seed" + std::to_string(i)).c_str(),
                    ImGuiDataType_U32, &ui_update.noises[i].seed);
                ImGui::Text("Strength");
                ImGui::SameLine();
                ImGui::InputFloat(
                    (hashtags + "strength" + std::to_string(i)).c_str(),
                    &ui_update.noises[i].strength, 0.1f);
                ImGui::Text("Octaves");
                ImGui::SameLine();
                ImGui::InputScalar(
                    (hashtags + "octaves" + std::to_string(i)).c_str(),
                    ImGuiDataType_U32, &ui_update.noises[i].octaves);
                ImGui::Text("Persistance");
                ImGui::SameLine();
                ImGui::InputScalar(
                    (hashtags + "persistance" + std::to_string(i)).c_str(),
                    ImGuiDataType_U32, &ui_update.noises[i].persistance);

                if (ImGui::Button(
                        ("Delete this noise ##" + std::to_string(i)).c_str()))
                {
                    currentPlanet->noises.erase(currentPlanet->noises.begin() +
                                                i);
                ...
                bool hasInputted =
                    currentPlanet->noises[i].octaves !=
                        ui_update.noises[i].octaves ||
                    currentPlanet->noises[i].persistance !=
                        ui_update.noises[i].persistance ||
                    currentPlanet->noises[i].seed != ui_update.noises[i].seed ||
                    currentPlanet->noises[i].strength !=
                        ui_update.noises[i].strength;
                if (hasInputted)
                {
                    ui_update.regeneratePlanet = true;
                }
                ui_update.noises[i].octaves = std::clamp(
                    static_cast<int>(ui_update.noises[i].octaves), 0, 100);
                currentPlanet->noises[i].seed = ui_update.noises[i].seed;
    ...
    if (ImGui::CollapsingHeader("Colors"))
    {
        for (int i = 0; i < currentPlanet->heights.size(); i++)
        {
                    ...
                    (std::string("Color ") + std::to_string(i)).c_str()))
            {
                ...
                ImGui::InputFloat(
                    (hashtags + "height" + std::to_string(i)).c_str(),
                    &ui_update.heights[i].height);
                if (ImGui::IsItemHovered())
                    ImGui::SetTooltip(
                        "The threshold after which color is applied");

                ImGui::Text("Color");
                ImGui::SameLine();
                ImGui::ColorPicker3(
                    (hashtags + "col" + std::to_string(i)).c_str(),
                    ui_update.heights[i].col);

                bool hasInputted = ui_update.heights[i].height !=
                                       currentPlanet->heights[i].height ||
                                   (ui_update.heights[i].col[0] !=
                                        currentPlanet->heights[i].col[0] &&
                                    ui_update.heights[i].col[1] !=
                                        currentPlanet->heights[i].col[1] &&
                                    ui_update.heights[i].col[2] !=
                                        currentPlanet->heights[i].col[2]);
                if (hasInputted)
                {
                    ui_update.regeneratePlanet = true;
                }
                ...
                std::copy(std::begin(ui_update.heights[i].col),
                          std::end(ui_update.heights[i].col),
                          std::begin(currentPlanet->heights[i].col));
            }
        }
    }
    ...
    if ((ui_update.tempNoise.octaves != 0 &&
         ui_update.tempNoise.strength != 0) &&
        (ui_update.tempNoise.persistance != 0 || ui_update.tempNoise.seed != 0))
    {
        if (ui_update.tempNoise.octaves != ui_update.lastTempNoise.octaves ||
            ui_update.tempNoise.persistance !=
                ui_update.lastTempNoise.persistance ||
    ...
    if (ui_update.regeneratePlanet)
    {
        ...
        currentPlanet->appliedNoise.resize(currentPlanet->mesh.vertices.size(),
                                           glm::vec3(0));
        ...
        {
            currentPlanet->mesh.vertices[i].position +=
                currentPlanet->appliedNoise[i];
        }
...
void DrawMenu()
{
    ...
    if (Menu::options)
    {
        ...
        if (bloom)
        {
            ImGui::Text("Exposure");
            ImGui::SameLine();
            ImGui::InputFloat("##Exposure", &exposure, 0.1f, 1.0f);
            ImGui::Text("BloomPasses");
            ImGui::SameLine();
            ImGui::InputInt("##BloomPasses", &bloomPasses, 1, 10);
        }
    ...
    if (Menu::loadScene)
    {
        ...
        {
            ImGui::SetCursorPosX(scr_width / 2 - scr_width / 8);
            if (ImGui::Button(Menu::files[i].c_str(),
                              ImVec2(scr_width / 4, 50.0f)))
...
void ExportScene(std::string fileName)
{
    ...
    if (f.good() && !Menu::saveFile)
    {
        ...
        Menu::exportPopupTxt =
            "Do you want to overwrite file: " + fileName + ".scene";
    ...
    for (auto planet : planets)
    {
        ...
        bufferSize +=
            sizeof(uint8_t) + planet.name.size() + sizeof(planet.mass) +
            sizeof(planet.emissionStrength) + sizeof(planet.emissionCol) +
            sizeof(planet.vel) + sizeof(planet.position) +
            sizeof(planet.rotation) + sizeof(planet.scale) +
            sizeof(planet.depth) + sizeof(planet.seed) +
            (planet.noises.size() * sizeof(Noise)) +
            (planet.heights.size() * sizeof(HeightCol)) + sizeof(uint32_t) * 2;
    }
    bufferSize += sizeof(numOfPlanets) + sizeof(oldTimeScale) +
                  sizeof(previewTimeStep) + sizeof(predictionDepth);
    ...
    for (auto planet : planets)
    {
        ...
        std::memcpy(buffer + beginning + stride + modifier, &nameLength,
                    sizeof(nameLength));
        modifier += sizeof(nameLength);

        std::memcpy(buffer + beginning + stride + modifier, name.c_str(),
                    name.size());
        modifier += name.size();

        std::memcpy(buffer + beginning + stride + modifier, &mass,
                    sizeof(mass));
        modifier += sizeof(mass);

        std::memcpy(buffer + beginning + stride + modifier, &emission,
                    sizeof(emission));
        modifier += sizeof(emission);

        std::memcpy(buffer + beginning + stride + modifier, &emissionCol,
                    sizeof(emissionCol));
        modifier += sizeof(emissionCol);

        std::memcpy(buffer + beginning + stride + modifier, &velocity,
                    sizeof(velocity));
        modifier += sizeof(velocity);

        std::memcpy(buffer + beginning + stride + modifier, &position,
                    sizeof(position));
        modifier += sizeof(position);

        std::memcpy(buffer + beginning + stride + modifier, &rotation,
                    sizeof(rotation));
        modifier += sizeof(rotation);

        std::memcpy(buffer + beginning + stride + modifier, &scale,
                    sizeof(scale));
        modifier += sizeof(scale);

        std::memcpy(buffer + beginning + stride + modifier, &depth,
                    sizeof(depth));
        modifier += sizeof(depth);

        std::memcpy(buffer + beginning + stride + modifier, &seed,
                    sizeof(seed));
        modifier += sizeof(seed);

        std::memcpy(buffer + beginning + stride + modifier, &noisesLength,
                    sizeof(noisesLength));
        modifier += sizeof(noisesLength);

        for (Noise &noise : planet.noises)
        {
            std::memcpy(buffer + beginning + stride + modifier, &noise,
                        sizeof(noise));
            modifier += sizeof(noise);
        }

        std::memcpy(buffer + beginning + stride + modifier, &heightsLength,
                    sizeof(heightsLength));
        modifier += sizeof(heightsLength);

        for (HeightCol &height : planet.heights)
        {
            std::memcpy(buffer + beginning + stride + modifier, &height,
                        sizeof(height));
    ...
    file.close();
    std::cout << "Wrote to file " << std::filesystem::current_path().string()
              << "\\scenes\\" << fileName << ".scene " << bufferSize
              << " bytes\n\n";
    Menu::saveFile = false;
...
void ImportScene(std::string fileName)
{
    ...
    std::ifstream file(std::string("scenes\\" + fileName).c_str(),
                       std::ios::binary);
    file.seekg(0, std::ios::end);
    size_t length = file.tellg();
    file.seekg(0, std::ios::beg);
    std::cout << "Loading file " << fileName << ", size: " << length
              << " bytes\n";
    ...
    for (int i = 0; i < numOfPlanets; i++)
    {
        ...
        std::memcpy(&nameLength, buffer + beginning + stride,
                    sizeof(nameLength));
        std::string name(static_cast<int>(nameLength), ' ');
        modifier += sizeof(nameLength);

        std::memcpy(&name[0], buffer + beginning + stride + modifier,
                    nameLength);
        modifier += (int)nameLength;

        std::memcpy(&mass, buffer + beginning + stride + modifier,
                    sizeof(mass));
        modifier += sizeof(mass);

        std::memcpy(&emission, buffer + beginning + stride + modifier,
                    sizeof(emission));
        modifier += sizeof(emission);

        std::memcpy(&emissionCol, buffer + beginning + stride + modifier,
                    sizeof(emissionCol));
        modifier += sizeof(emissionCol);

        std::memcpy(&velocity, buffer + beginning + stride + modifier,
                    sizeof(velocity));
        modifier += sizeof(velocity);

        std::memcpy(&position, buffer + beginning + stride + modifier,
                    sizeof(position));
        modifier += sizeof(position);

        std::memcpy(&rotation, buffer + beginning + stride + modifier,
                    sizeof(rotation));
        modifier += sizeof(rotation);

        std::memcpy(&scale, buffer + beginning + stride + modifier,
                    sizeof(scale));
        modifier += sizeof(scale);

        std::memcpy(&depth, buffer + beginning + stride + modifier,
                    sizeof(depth));
        modifier += sizeof(depth);

        std::memcpy(&seed, buffer + beginning + stride + modifier,
                    sizeof(seed));
        modifier += sizeof(seed);

        std::memcpy(&noisesLength, buffer + beginning + stride + modifier,
                    sizeof(noisesLength));
        modifier += sizeof(noisesLength);
        ...
        {
            Noise tempNoise{};
            std::memcpy(&tempNoise, buffer + beginning + stride + modifier,
                        sizeof(tempNoise));
            noises.emplace_back(tempNoise);
            modifier += sizeof(tempNoise);
        }

        std::memcpy(&heightsLength, buffer + beginning + stride + modifier,
                    sizeof(heightsLength));
        modifier += sizeof(heightsLength);
        ...
        for (int i = 0; i < heightsLength; i++)
        {
            ...
            std::memcpy(&tempHeight, buffer + beginning + stride + modifier,
                        sizeof(tempHeight));
